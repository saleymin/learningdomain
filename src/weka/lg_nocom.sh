...
java -cp /disk2/home/suleyman/software/weka-3-6-13/weka.jar  weka.filters.unsupervised.attribute.Remove -R first-3,5,6,7-8,20-38 -i $tempFile -o  "$outputDir/data_00.arff" 
